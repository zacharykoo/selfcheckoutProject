...
public class TestCardIssuerDatabase{
    ...
    public void setupTest() throws IOException
    {
        ...
        //OK: Java doesn't have macros, so the programmer needs to get cancer by copy pasting the same thing super verbosely every time ... woohooo I love Java <3
        visa_issuer.addCardData(
                getTapCardData(cardList.get(0)).getNumber(),
                getTapCardData(cardList.get(0)).getCardholder(),
                DEFAULT_EXP_DATE,
                getTapCardData(cardList.get(0)).getCVV(),
                DEFAULT_AMMOUNT
        );

        masterCard_issuer.addCardData(
                getTapCardData(cardList.get(1)).getNumber(),
                getTapCardData(cardList.get(1)).getCardholder(),
                DEFAULT_EXP_DATE,
                getTapCardData(cardList.get(1)).getCVV(),
                DEFAULT_AMMOUNT
        );

        debit_issuer.addCardData(
                getTapCardData(cardList.get(2)).getNumber(),
                getTapCardData(cardList.get(2)).getCardholder(),
                DEFAULT_EXP_DATE,
                getTapCardData(cardList.get(2)).getCVV(),
                DEFAULT_AMMOUNT
        );
        debit_issuer.addCardData(
                getTapCardData(cardList.get(3)).getNumber(),
                getTapCardData(cardList.get(3)).getCardholder(),
                DEFAULT_EXP_DATE,
                getTapCardData(cardList.get(3)).getCVV(),
                DEFAULT_AMMOUNT
        );

        debit_issuer.addCardData(
                getTapCardData(cardList.get(4)).getNumber(),
                getTapCardData(cardList.get(4)).getCardholder(),
                DEFAULT_EXP_DATE,
                getTapCardData(cardList.get(4)).getCVV(),
                DEFAULT_AMMOUNT
        );
