...
public class AddCoin implements CoinValidatorObserver {
	 ...
	 * 
	 * @param state
	 * 		The instance of the system state to which inserted coin's value are
	 * 		to be accumulated.
	 */
	 ...
	 * @param currency
	 * 		The currency instance for the currency of the inserted coin.
	 * @param value
